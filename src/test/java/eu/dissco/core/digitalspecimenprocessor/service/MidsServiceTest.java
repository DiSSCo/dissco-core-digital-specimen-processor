...
class MidsServiceTest {
	...
	private static Stream<Arguments> provideDigitalSpecimen() {
		return Stream.of(Arguments.of(TestUtils.givenDigitalSpecimenWrapper(), 0),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenPreparationValue(null),
						MAPPER.createObjectNode()), 0),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenPreparationValue("      "),
						MAPPER.createObjectNode()), 0),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenPreparationValue("null"),
						MAPPER.createObjectNode()), 0),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenMissingTopic(),
						MAPPER.createObjectNode()), 0),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenPreparationValue("in alcohol"), MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenMissingLongitude(),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenMissingCountry(),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenInvalidType(),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenBotanySpecimen(Boolean.FALSE), MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenBotanySpecimen(null),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenBotanySpecimenMissingFieldNumber(), MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenMissingLocation(),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenMissingGeoReference(),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenBotanyNoOccurrenceSpecimen(List.of()), MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenBotanyNoOccurrenceSpecimen(null), MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
				...
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(new Location().withOdsHasGeoreference(new Georeference())),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(new Location().withOdsHasGeoreference(null)),
						MAPPER.createObjectNode()), 1),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenBotanySpecimen(Boolean.TRUE), MAPPER.createObjectNode()), 2),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenBotanySpecimenAlternative(), MAPPER.createObjectNode()), 2),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenFullPaleoSpecimen(),
						MAPPER.createObjectNode()), 2),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenFullBioSpecimenMissingTax(true, null), MAPPER.createObjectNode()), 2),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenFullBioSpecimenMissingTax(false, "ID2"), MAPPER.createObjectNode()), 2),

				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(givenMissingUncertaintyLocation()), MAPPER.createObjectNode()),
						2),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(givenMissingPercisionLocation()), MAPPER.createObjectNode()), 2),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(givenLocationId()), MAPPER.createObjectNode()), 3),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID, givenMidsThreeBioSpecimen(),
						MAPPER.createObjectNode()), 3),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(givenFootprintLocation()), MAPPER.createObjectNode()), 3),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(givenVerbatimCoordinateLocation()), MAPPER.createObjectNode()),
						3),
				Arguments.of(new DigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, TYPE_PID,
						givenMidsThreeGenericSpecimen(givenVerbatimLatLongLocation()), MAPPER.createObjectNode()), 3));
	}

	private static DigitalSpecimen givenFullBioSpecimenMissingTax(boolean missingName, String identifierId) {
		return baseDigitalSpecimen().withDwcPreparations("single specimen")
			...
			.withOdsHasIdentifications(
					List.of(new Identification().withOdsHasAgents(createAgent(identifierId, IDENTIFIER))
						.withOdsHasTaxonIdentifications(List
							.of(new TaxonIdentification().withDwcScientificNameID(missingName ? "ID2" : null)))))
			.withOdsIsKnownToContainMedia(true)
			.withOdsIsMarkedAsType(false)
			.withOdsHasEvents(List.of(new Event().withDwcVerbatimEventDate("A verbatim date as is on the label")
				.withDwcFieldNumber("1202")
				.withOdsHasAgents(createAgent("ORCID", COLLECTOR))
				.withOdsHasLocation(new Location().withDwcCountry("Estonia")
	...
	private static DigitalSpecimen givenBotanySpecimenMissingFieldNumber() {
		return baseDigitalSpecimen().withDwcPreparations("in alcohol")
			...
			.withOdsIsMarkedAsType(false)
			.withOdsHasEvents(
					List.of(new Event().withDwcYear(2023)
	...
	private static DigitalSpecimen givenMissingLocation() {
		return baseDigitalSpecimen().withDwcPreparations("single specimen")
			...
			.withOdsHasIdentifications(List.of(new Identification().withDwcIdentificationID("ID1")
				.withOdsHasTaxonIdentifications(List.of(new TaxonIdentification().withDwcScientificNameID("ID2")))))
	...
	private static DigitalSpecimen givenMidsThreeBioSpecimen() {
		return baseDigitalSpecimen().withDwcPreparations("single specimen")
			.withOdsIsMarkedAsType(true)
			.withOdsTopicDiscipline(OdsTopicDiscipline.BOTANY)
			.withOdsHasIdentifications(List.of(new Identification().withOdsHasAgents(createAgent("ID1", IDENTIFIER))
				.withOdsHasTaxonIdentifications(List.of(new TaxonIdentification().withDwcScientificNameID("ID2")))))
			.withOdsIsKnownToContainMedia(true)
			.withOdsIsMarkedAsType(false)
			.withOdsHasEvents(List.of(new Event().withDwcVerbatimEventDate("A verbatim date as is on the label")
	...
	private static Location givenLocationId() {
		return new Location().withDwcCountry("Estonia")
			.withDwcCountryCode("EE")
			.withDwcLocationID("LOC_ID")
			.withOdsHasGeoreference(
					new Georeference().withDwcDecimalLatitude(59.465625).withDwcDecimalLongitude(25.059035))
			.withOdsHasGeologicalContext(new GeologicalContext().withDwcGroup("Group"));
	}
	...
	private static Location givenVerbatimCoordinateLocation() {
		return new Location().withDwcLocationID("LOC_ID")
			.withOdsHasGeoreference(new Georeference().withDwcVerbatimCoordinates("59.465625, 25.059035"))
			.withOdsHasGeologicalContext(new GeologicalContext().withDwcGroup("Group"));
	}
	...
	private static Location givenVerbatimLatLongLocation() {
		return new Location().withDwcLocationID("LOC_ID")
			.withOdsHasGeoreference(
					new Georeference().withDwcVerbatimLatitude("59.465625").withDwcVerbatimLongitude("25.059035"))
			.withOdsHasGeologicalContext(new GeologicalContext().withDwcGroup("Group"));
	}

	private static Location givenMissingUncertaintyLocation() {
		return new Location().withDwcCountry("The Netherlands")
			.withOdsHasGeoreference(new Georeference().withDwcDecimalLatitude(59.465625)
				.withDwcDecimalLongitude(25.059035)
				.withDwcGeodeticDatum("WGS84"))
			.withOdsHasGeologicalContext(new GeologicalContext().withDwcGroup("Group"));
	...
	private static DigitalSpecimen givenFullPaleoSpecimen() {
		return baseDigitalSpecimen().withDwcPreparations("single specimen")
			.withOdsIsMarkedAsType(false)
			.withOdsTopicDiscipline(OdsTopicDiscipline.PALAEONTOLOGY)
			.withOdsHasEvents(List.of(new Event().withOdsHasLocation(new Location().withDwcCountry("Estonia")
				.withDwcCountryCode("EE")
				.withOdsHasGeoreference(
						new Georeference().withDwcDecimalLatitude(59.465625).withDwcDecimalLongitude(25.059035))
				.withOdsHasGeologicalContext(new GeologicalContext().withDwcGroup("Group")))));
	...
	private static DigitalSpecimen givenBotanySpecimen(Boolean hasMedia) {
		return baseDigitalSpecimen().withDwcPreparations("in alcohol")
			...
			.withOdsIsMarkedAsType(true)
			.withOdsHasEvents(
					List.of(new Event().withOdsHasAgents(createAgent(null, COLLECTOR))
	...
	private static List<Agent> createAgent(String id, AgentRoleType role) {
		return List.of(AgentUtils.createMachineAgent("Sam Leeflang", id, role, null, Type.SCHEMA_PERSON));
	}
	...
	private static DigitalSpecimen givenMissingCountry() {
		return baseDigitalSpecimen().withDwcPreparations("single specimen")
			.withOdsIsMarkedAsType(true)
			.withOdsTopicDiscipline(OdsTopicDiscipline.PALAEONTOLOGY)
			.withOdsHasEvents(List.of(new Event().withOdsHasLocation(new Location()
				.withOdsHasGeoreference(
						new Georeference().withDwcDecimalLatitude(59.465625).withDwcDecimalLongitude(25.059035))
				.withOdsHasGeologicalContext(new GeologicalContext().withDwcEarliestEonOrLowestEonothem("Archean")))));
	}

	private static DigitalSpecimen givenMissingTopic() {
		return baseDigitalSpecimen().withDwcPreparations("alcohol")
	...
	private static DigitalSpecimen givenPreparationValue(String preparationValue) {
		return baseDigitalSpecimen().withDwcPreparations(preparationValue)
			.withOdsTopicDiscipline(OdsTopicDiscipline.PALAEONTOLOGY);
	}

	private static DigitalSpecimen baseDigitalSpecimen() {
		return new DigitalSpecimen().withOdsPhysicalSpecimenIDType(PHYSICAL_SPECIMEN_TYPE)
