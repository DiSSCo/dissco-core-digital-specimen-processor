...
public class TestUtils {
	...
	public static DigitalSpecimenRecord givenDigitalSpecimenRecord(String handle) {
		return new DigitalSpecimenRecord(handle, MIDS_LEVEL, 1, CREATED, givenDigitalSpecimenWrapper(), Set.of(MAS),
				false, true, List.of());
	}

	public static DigitalSpecimenRecord givenDigitalSpecimenRecord(int version, boolean hasMedia) {
		return new DigitalSpecimenRecord(HANDLE, MIDS_LEVEL, version, CREATED, givenDigitalSpecimenWrapper(hasMedia),
				Set.of(MAS), false, true, List.of());
	}
	...
	public static DigitalSpecimenRecord givenDigitalSpecimenRecordWithMediaEr(String handle, String physicalId,
			boolean addOtherEntityRelationship, int version) {
		return givenDigitalSpecimenRecordWithMediaEr(handle, physicalId, addOtherEntityRelationship, version,
				MEDIA_PID);
	}

	public static DigitalSpecimenRecord givenDigitalSpecimenRecordWithMediaEr(String handle, String physicalId,
			boolean addOtherEntityRelationship, int version, String mediaId) {
		return new DigitalSpecimenRecord(handle, MIDS_LEVEL, version, CREATED,
				givenDigitalSpecimenWrapperWithMediaEr(physicalId, addOtherEntityRelationship, mediaId), Set.of(MAS),
				false, true, List.of(givenDigitalMediaEvent()));
	}
	...
	public static DigitalSpecimenRecord givenUnequalDigitalSpecimenRecord(String handle, String specimenName,
			String organisation, boolean hasMedia, boolean isDataFromSourceSystem) {
		return givenUnequalDigitalSpecimenRecord(handle, specimenName, organisation, hasMedia, PHYSICAL_SPECIMEN_ID,
				isDataFromSourceSystem);
	}

	public static DigitalSpecimenRecord givenUnequalDigitalSpecimenRecord(String handle, String specimenName,
			String organisation, boolean hasMedia) {
		return givenUnequalDigitalSpecimenRecord(handle, specimenName, organisation, hasMedia, PHYSICAL_SPECIMEN_ID,
				true);
	}

	public static DigitalSpecimenRecord givenUnequalDigitalSpecimenRecord(String handle, String specimenName,
			String organisation, boolean hasMedia, String physicalSpecimenId, boolean isDataFromSourceSystem) {
		return new DigitalSpecimenRecord(
				handle, MIDS_LEVEL, VERSION, CREATED, givenDigitalSpecimenWrapper(physicalSpecimenId, specimenName,
						organisation, false, hasMedia, UPDATED_ORIGINAL_DATA),
				Set.of(MAS), false, isDataFromSourceSystem, List.of());
	}
	...
	public static DigitalSpecimenRecord givenDigitalSpecimenRecord(String handle, String physicalSpecimenId,
		...
		return new DigitalSpecimenRecord(handle, MIDS_LEVEL, VERSION, CREATED,
				givenDigitalSpecimenWrapper(physicalSpecimenId, SPECIMEN_NAME, ORGANISATION_ID, false, hasMedia,
						ORIGINAL_DATA),
				Set.of(MAS), false, true, mediaEvents);
	}
	...
	public static DigitalSpecimenEvent givenDigitalSpecimenEvent(String physicalSpecimenId, boolean hasMedia,
		...
		List<DigitalMediaEvent> mediaEvents = hasMedia ? List.of(givenDigitalMediaEvent()) : List.of();
		return new DigitalSpecimenEvent(Set.of(MAS), givenDigitalSpecimenWrapper(physicalSpecimenId, SPECIMEN_NAME,
				ORGANISATION_ID, false, hasMedia, ORIGINAL_DATA), mediaEvents, false, isDataFromSourceSystem);
	}
	...
	public static DigitalMediaRecord givenDigitalMediaRecord(String pid, String uri, int version) {
		return new DigitalMediaRecord(pid, uri, version, CREATED, Set.of(MEDIA_MAS), givenDigitalMedia(uri, true),
	...
	public static DigitalMediaRecord givenDigitalMediaRecordNoMas() {
		return new DigitalMediaRecord(MEDIA_PID, MEDIA_URL, VERSION, CREATED, Set.of(),
				new DigitalMedia().withOdsFdoType(FdoType.MEDIA.getPid())
					.withAcAccessURI(MEDIA_URL)
					.withOdsOrganisationID(ORGANISATION_ID)
					.withOdsHasEntityRelationships(List.of(givenEntityRelationship(),
							givenEntityRelationship(HANDLE,
	...
	public static DigitalMediaEvent givenUnequalDigitalMediaEvent(String url, boolean addSpecimenEr) {
		return new DigitalMediaEvent(Set.of(MEDIA_MAS), new DigitalMediaWrapper(FdoType.MEDIA.getPid(),
				givenUnequalDigitalMedia(url, addSpecimenEr), UPDATED_ORIGINAL_DATA_MEDIA), false, true);
	}
	...
	public static DigitalMediaRecord givenUnequalDigitalMediaRecord(String pid, String url, int version) {
		var media = givenUnequalDigitalMedia(url, true);
		return new DigitalMediaRecord(pid, url, version, CREATED, Set.of(MEDIA_MAS), media, UPDATED_ORIGINAL_DATA_MEDIA,
				false, true);
	}

	public static DigitalMedia givenUnequalDigitalMedia(String url, boolean addSpecimenEr) {
		List<EntityRelationship> ers = addSpecimenEr
				? List.of(givenEntityRelationship(),
						givenEntityRelationship(HANDLE, EntityRelationshipType.HAS_SPECIMEN.getRelationshipName()))
				: List.of(givenEntityRelationship());
		return new DigitalMedia().withOdsFdoType(FdoType.MEDIA.getPid())
	...
	public static DigitalSpecimenEvent givenDigitalSpecimenEvent(boolean hasMedia, boolean entityRelationship,
			boolean isDataFromSourceSystem) {
		return new DigitalSpecimenEvent(Set.of(MAS), givenDigitalSpecimenWrapper(entityRelationship, hasMedia),
				hasMedia ? List.of(givenDigitalMediaEvent()) : List.of(), false, isDataFromSourceSystem);
	}

	public static DigitalSpecimenWrapper givenDigitalSpecimenWrapperWithMediaEr(String physicalId,
			Boolean addOtherEntityRelationship) {
		return givenDigitalSpecimenWrapperWithMediaEr(physicalId, addOtherEntityRelationship, MEDIA_PID);
	}

	public static DigitalSpecimenWrapper givenDigitalSpecimenWrapperWithMediaEr(String physicalId,
			Boolean addOtherEntityRelationship, String mediaId) {
		var attributes = givenAttributes(SPECIMEN_NAME, ORGANISATION_ID, true, addOtherEntityRelationship, true);
		var entityRelationships = new ArrayList<>(attributes.getOdsHasEntityRelationships());
		entityRelationships
			.add(givenEntityRelationship(mediaId, EntityRelationshipType.HAS_MEDIA.getRelationshipName()));
		attributes.setOdsHasEntityRelationships(entityRelationships);
		return new DigitalSpecimenWrapper(physicalId, TYPE_PID, attributes, ORIGINAL_DATA);
	}

	public static EntityRelationship givenEntityRelationship(String relatedId, String relationshipType) {
		return new EntityRelationship().withType("ods:EntityRelationship")
			.withDwcRelationshipEstablishedDate(Date.from(CREATED))
			.withDwcRelationshipOfResource(relationshipType)
			.withOdsHasAgents(List
				.of(createMachineAgent(APP_NAME, APP_HANDLE, PROCESSING_SERVICE, DOI, SCHEMA_SOFTWARE_APPLICATION)))
	...
	public static DigitalMediaEvent givenDigitalMediaEventWithSpecimenEr() {
		return new DigitalMediaEvent(Set.of(MEDIA_MAS), givenDigitalMediaWrapper(MEDIA_URL, true), false, true);

	}

	public static DigitalMediaEvent givenDigitalMediaEvent(String mediaUrl) {
		return new DigitalMediaEvent(Set.of(MEDIA_MAS), givenDigitalMediaWrapper(mediaUrl, false), false, true);
	}
	...
	public static DigitalMediaEvent givenDigitalMediaEventWithRelationship(String id) {
		var digitalMedia = new DigitalMedia().withOdsFdoType(FdoType.MEDIA.getPid())
			.withAcAccessURI(MEDIA_URL)
			.withId(id)
			.withDctermsIdentifier(id)
			.withOdsOrganisationID(ORGANISATION_ID)
			.withOdsHasEntityRelationships(List.of(new EntityRelationship().withType("ods:EntityRelationship")
		...
		return new DigitalMediaEvent(Set.of(MEDIA_MAS),
				new DigitalMediaWrapper("StillImage", digitalMedia, MAPPER.createObjectNode()), false, true);
	}
	...
	public static DigitalSpecimenWrapper givenDigitalSpecimenWrapper(boolean entityRelationship, boolean hasMedia) {
		return givenDigitalSpecimenWrapper(PHYSICAL_SPECIMEN_ID, SPECIMEN_NAME, ORGANISATION_ID, entityRelationship,
				hasMedia, ORIGINAL_DATA);
	}

	public static DigitalSpecimenWrapper givenDigitalSpecimenWrapper(String physicalSpecimenId, String specimenName,
			String organisation, boolean entityRelationship, boolean hasMedia, JsonNode originalData) {
		return new DigitalSpecimenWrapper(physicalSpecimenId, TYPE_PID,
				givenAttributes(specimenName, organisation, true, entityRelationship, hasMedia), originalData);
	}
	...
	public static Map<String, String> givenHandleResponse(List<String> localIds, List<String> pids) {
	...
	public static Map<String, String> givenHandleResponseSpecimen(List<DigitalSpecimenRecord> records) {
		Map<String, String> response = new HashMap<>();
		for (var specimenRecord : records) {
			response.put(specimenRecord.digitalSpecimenWrapper().physicalSpecimenID(), specimenRecord.id());
		}
		return response;
	}
	...
	public static JsonNode givenUpdateHandleRequest(Boolean markedAsType) {
		...
		return MAPPER.createObjectNode()
			.set("data",
					MAPPER.createObjectNode().put("id", HANDLE).put("type", TYPE_PID).set("attributes", attributes));
	}
	...
	public static JsonNode givenPidRequest(Boolean markedAsType) {
		...
		return MAPPER.createObjectNode()
			.set("data", MAPPER.createObjectNode().put("type", TYPE_PID).set("attributes", attributes));
	}
	...
	public static UpdatedDigitalSpecimenRecord givenUpdatedDigitalSpecimenRecord(DigitalSpecimenRecord currentRecord,
			boolean hasMedia) {
		if (hasMedia) {
			return new UpdatedDigitalSpecimenRecord(givenDigitalSpecimenRecord(2, true), Set.of(MAS), currentRecord,
					givenJsonPatchSpecimen(), List.of(givenDigitalMediaEvent()),
					new MediaRelationshipProcessResult(List.of(), List.of(givenDigitalMediaEvent()), List.of()), true);
		}
		return new UpdatedDigitalSpecimenRecord(givenDigitalSpecimenRecord(2, false), Set.of(MAS), currentRecord,
				givenJsonPatchSpecimen(), List.of(), givenEmptyMediaProcessResult(), true);
	}

	public static DigitalSpecimen givenAttributes(String specimenName, String organisation, Boolean markedAsType,
			boolean addEntityRelationShip, boolean containsMedia) {
		var ds = new DigitalSpecimen().withOdsOrganisationID(organisation)
		...
		if (addEntityRelationShip) {
			ds.withOdsHasEntityRelationships(List.of(givenEntityRelationship()));
		}
		return ds;
	}

	public static DigitalSpecimen givenAttributesPlusIdentifier(String specimenName, String organisation,
			Boolean markedAsType) {
		return givenAttributes(specimenName, organisation, markedAsType, false, false).withOdsHasIdentifiers(
				List.of(new Identifier().withDctermsTitle("Specimen label").withDctermsIdentifier(HANDLE)));
	}

	public static AutoAcceptedAnnotation givenAutoAcceptedAnnotation(AnnotationProcessingRequest annotation) {
		return new AutoAcceptedAnnotation(
				createMachineAgent(APP_NAME, APP_HANDLE, PROCESSING_SERVICE, DOI, SCHEMA_SOFTWARE_APPLICATION),
				annotation);
	}
	...
	public static AnnotationProcessingRequest givenNewAcceptedAnnotation() {
		return new AnnotationProcessingRequest().withOaMotivation(OaMotivation.ODS_ADDING)
			.withOaMotivatedBy("New information received from Source System with id: " + SOURCE_SYSTEM_ID)
			.withOaHasBody(new AnnotationBody().withType("oa:TextualBody")
				.withOaValue(List.of(MAPPER
					.writeValueAsString(DigitalObjectUtils.flattenToDigitalSpecimen(givenDigitalSpecimenRecord()))))
			...
			.withOaHasTarget(new AnnotationTarget().withId(DOI_PREFIX + HANDLE)
				.withDctermsIdentifier(DOI_PREFIX + HANDLE)
				.withType(TYPE)
				.withOdsFdoType(TYPE_PID)
				.withOaHasSelector(new OaHasSelector().withAdditionalProperty("@type", "ods:ClassSelector")
					.withAdditionalProperty("ods:class", "$")));

	}

	public static JsonNode givenJsonPatchSpecimen() {
		return MAPPER.readTree("[{\"op\":\"replace\",\"path\":\"/ods:specimenName\",\"value\":\"Biota\"}]");
	}
	...
	public static UpdatedDigitalSpecimenTuple givenUpdatedDigitalSpecimenTuple(boolean hasMedia,
		...
		return new UpdatedDigitalSpecimenTuple(
				...
				givenDigitalSpecimenEvent(hasMedia, false, isDataFromSourceSystem), mediaRelations);
	}
	...
	public static UpdatedDigitalMediaTuple givenUpdatedDigitalMediaTuple(boolean hasNewSpecimen) {
		...
		return new UpdatedDigitalMediaTuple(givenUnequalDigitalMediaRecord(), givenDigitalMediaEvent(),
				specimenRelations);
	}

	public static UpdatedDigitalMediaRecord givenUpdatedDigitalMediaRecord() {
		return new UpdatedDigitalMediaRecord(givenDigitalMediaRecord(2), Set.of(MEDIA_MAS), givenDigitalMediaRecord(),
				givenJsonPatchMedia());
	}

	public static UpdatedDigitalMediaRecord givenUpdatedDigitalMediaRecord(String pid, String uri) {
		return new UpdatedDigitalMediaRecord(givenDigitalMediaRecord(pid, uri, 2), Set.of(MEDIA_MAS),
				givenDigitalMediaRecord(pid, uri, 1), givenJsonPatchMedia());
	}

	public static MasJobRequest givenMasJobRequestMedia() {
		return new MasJobRequest(MEDIA_MAS, MEDIA_PID, false, APP_HANDLE, MjrTargetType.MEDIA_OBJECT);
	}
