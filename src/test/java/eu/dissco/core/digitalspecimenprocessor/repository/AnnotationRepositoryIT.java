...
class AnnotationRepositoryIT extends BaseRepositoryIT {
	...
	void testGetAcceptedAnnotations() {
		...
		var annotation2 = givenAnnotation(OaMotivation.OA_EDITING, true, HANDLE_PREFIX + ANNOTATION_ID_2,
				DOI_PREFIX + HANDLE);
		var annotation3 = givenAnnotation(HANDLE_PREFIX + ANNOTATION_ID_3, DOI_PREFIX + SECOND_HANDLE);
		var annotation4 = givenAnnotation(OaMotivation.OA_EDITING, true, HANDLE_PREFIX + THIRD_HANDLE,
				DOI_PREFIX + HANDLE);
		var expected = Map.of(HANDLE, List.of(annotation1, annotation2), SECOND_HANDLE, List.of(annotation3));
		var annotations = Map.of(annotation1, AnnotationStatusEnum.ACCEPTED, annotation2, AnnotationStatusEnum.ACCEPTED,
				annotation3, AnnotationStatusEnum.ACCEPTED, annotation4, AnnotationStatusEnum.MERGED);
