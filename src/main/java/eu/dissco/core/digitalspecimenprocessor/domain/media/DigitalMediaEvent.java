...
public record DigitalMediaEvent(Set<String> masList,
		@JsonProperty("digitalMedia") DigitalMediaWrapper digitalMediaWrapper, Boolean forceMasSchedule,
		Boolean isDataFromSourceSystem) {

	public DigitalMediaEvent(Set<String> masList, DigitalMediaWrapper digitalMediaWrapper, Boolean forceMasSchedule,
			Boolean isDataFromSourceSystem) {
