...
public class SourceSystem extends TableImpl<SourceSystemRecord> {
   ...
   */
  public final TableField<SourceSystemRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.source_system.version</code>.
   */
  public final TableField<SourceSystemRecord, Integer> VERSION = createField(DSL.name("version"),
   ...
   */
  public final TableField<SourceSystemRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.source_system.endpoint</code>.
   */
  public final TableField<SourceSystemRecord, String> ENDPOINT = createField(DSL.name("endpoint"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.source_system.created</code>.
   */
  public final TableField<SourceSystemRecord, Instant> CREATED = createField(DSL.name("created"),
      SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.source_system.modified</code>.
   */
  public final TableField<SourceSystemRecord, Instant> MODIFIED = createField(DSL.name("modified"),
      SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.source_system.tombstoned</code>.
   */
  public final TableField<SourceSystemRecord, Instant> TOMBSTONED = createField(
      DSL.name("tombstoned"), SQLDataType.INSTANT, this, "");

  /**
   * The column <code>public.source_system.mapping_id</code>.
   */
  public final TableField<SourceSystemRecord, String> MAPPING_ID = createField(
      DSL.name("mapping_id"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.source_system.creator</code>.
   */
  public final TableField<SourceSystemRecord, String> CREATOR = createField(DSL.name("creator"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.source_system.translator_type</code>.
   */
  public final TableField<SourceSystemRecord, TranslatorType> TRANSLATOR_TYPE = createField(
      DSL.name("translator_type"),
      SQLDataType.VARCHAR.nullable(false).asEnumDataType(TranslatorType.class), this, "");

  /**
   * The column <code>public.source_system.data</code>.
   */
  public final TableField<SourceSystemRecord, JSONB> DATA = createField(DSL.name("data"),
      SQLDataType.JSONB.nullable(false), this, "");

  /**
   * The column <code>public.source_system.dwc_dp_link</code>.
   */
  public final TableField<SourceSystemRecord, String> DWC_DP_LINK = createField(
      DSL.name("dwc_dp_link"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.source_system.dwca_link</code>.
   */
  public final TableField<SourceSystemRecord, String> DWCA_LINK = createField(DSL.name("dwca_link"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.source_system.eml</code>.
   */
  public final TableField<SourceSystemRecord, byte[]> EML = createField(DSL.name("eml"),
