...
public class DigitalSpecimen extends TableImpl<DigitalSpecimenRecord> {
	 ...
	 */
	public final TableField<DigitalSpecimenRecord, String> ID = createField(DSL.name("id"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.version</code>.
	 */
	public final TableField<DigitalSpecimenRecord, Integer> VERSION = createField(DSL.name("version"),
			SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.type</code>.
	 */
	public final TableField<DigitalSpecimenRecord, String> TYPE = createField(DSL.name("type"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.midslevel</code>.
	 */
	public final TableField<DigitalSpecimenRecord, Short> MIDSLEVEL = createField(DSL.name("midslevel"),
			SQLDataType.SMALLINT.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.physical_specimen_id</code>.
	 */
	public final TableField<DigitalSpecimenRecord, String> PHYSICAL_SPECIMEN_ID = createField(
			DSL.name("physical_specimen_id"), SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.physical_specimen_type</code>.
	 */
	public final TableField<DigitalSpecimenRecord, String> PHYSICAL_SPECIMEN_TYPE = createField(
			DSL.name("physical_specimen_type"), SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.specimen_name</code>.
	 */
	public final TableField<DigitalSpecimenRecord, String> SPECIMEN_NAME = createField(DSL.name("specimen_name"),
			SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.digital_specimen.organization_id</code>.
	 */
	public final TableField<DigitalSpecimenRecord, String> ORGANIZATION_ID = createField(DSL.name("organization_id"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.source_system_id</code>.
	 */
	public final TableField<DigitalSpecimenRecord, String> SOURCE_SYSTEM_ID = createField(DSL.name("source_system_id"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.created</code>.
	 */
	public final TableField<DigitalSpecimenRecord, Instant> CREATED = createField(DSL.name("created"),
			SQLDataType.INSTANT.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.last_checked</code>.
	 */
	public final TableField<DigitalSpecimenRecord, Instant> LAST_CHECKED = createField(DSL.name("last_checked"),
			SQLDataType.INSTANT.nullable(false), this, "");

	/**
	 * The column <code>public.digital_specimen.deleted</code>.
	 */
	public final TableField<DigitalSpecimenRecord, Instant> DELETED = createField(DSL.name("deleted"),
	 ...
	 */
	public final TableField<DigitalSpecimenRecord, JSONB> ORIGINAL_DATA = createField(DSL.name("original_data"),
			SQLDataType.JSONB, this, "");

	/**
	 * The column <code>public.digital_specimen.modified</code>.
	 */
	public final TableField<DigitalSpecimenRecord, Instant> MODIFIED = createField(DSL.name("modified"),
			SQLDataType.INSTANT, this, "");

	/**
	 * The column <code>public.digital_specimen.col_id</code>.
	 */
	public final TableField<DigitalSpecimenRecord, String> COL_ID = createField(DSL.name("col_id"), SQLDataType.CLOB,
			this, "");
