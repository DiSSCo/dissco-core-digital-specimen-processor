...
public class DigitalMediaObject extends TableImpl<DigitalMediaObjectRecord> {
   ...
   */
  public final TableField<DigitalMediaObjectRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.digital_media_object.version</code>.
   */
  public final TableField<DigitalMediaObjectRecord, Integer> VERSION = createField(
      DSL.name("version"), SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * The column <code>public.digital_media_object.type</code>.
   */
  public final TableField<DigitalMediaObjectRecord, String> TYPE = createField(DSL.name("type"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.digital_media_object.digital_specimen_id</code>.
   */
  public final TableField<DigitalMediaObjectRecord, String> DIGITAL_SPECIMEN_ID = createField(
      DSL.name("digital_specimen_id"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.digital_media_object.media_url</code>.
   */
  public final TableField<DigitalMediaObjectRecord, String> MEDIA_URL = createField(
      DSL.name("media_url"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.digital_media_object.created</code>.
   */
  public final TableField<DigitalMediaObjectRecord, Instant> CREATED = createField(
      DSL.name("created"), SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.digital_media_object.last_checked</code>.
   */
  public final TableField<DigitalMediaObjectRecord, Instant> LAST_CHECKED = createField(
      DSL.name("last_checked"), SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.digital_media_object.deleted</code>.
   */
  public final TableField<DigitalMediaObjectRecord, Instant> DELETED = createField(
      DSL.name("deleted"), SQLDataType.INSTANT, this, "");

  /**
   * The column <code>public.digital_media_object.data</code>.
   */
  public final TableField<DigitalMediaObjectRecord, JSONB> DATA = createField(DSL.name("data"),
      SQLDataType.JSONB.nullable(false), this, "");

  /**
   * The column <code>public.digital_media_object.original_data</code>.
   */
  public final TableField<DigitalMediaObjectRecord, JSONB> ORIGINAL_DATA = createField(
      DSL.name("original_data"), SQLDataType.JSONB.nullable(false), this, "");
  ...
  /**
   * Create an aliased <code>public.digital_media_object</code> table reference
   */
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(Indexes.DIGITAL_MEDIA_OBJECT_DIGITAL_SPECIMEN_ID_URL,
        Indexes.DIGITAL_MEDIA_OBJECT_ID_IDX, Indexes.DIGITAL_MEDIA_OBJECT_ID_VERSION_URL);
  }
