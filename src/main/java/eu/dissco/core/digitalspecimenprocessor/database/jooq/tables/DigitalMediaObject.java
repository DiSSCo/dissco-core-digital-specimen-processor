...
public class DigitalMediaObject extends TableImpl<DigitalMediaObjectRecord> {
     ...
     */
    public final TableField<DigitalMediaObjectRecord, String> SOURCE_SYSTEM_ID = createField(DSL.name("source_system_id"), SQLDataType.CLOB, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.DIGITAL_MEDIA_OBJECT_ID_IDX, Indexes.DIGITAL_MEDIA_OBJECT_ID_VERSION_URL, Indexes.DIGITAL_MEDIA_SOURCE_SYSTEM_ID_INDEX);
    }
